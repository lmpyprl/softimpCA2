...
public abstract class Person {
	...
	/****
	abtract toString() method 
	  Abstract because we want all subclasses to display themselves,
	  but we do not know how they will implement the method yet.
	  Abstract means the subclasses will have to override the toString() method                        
	@Override  // Overrides Object toString()
