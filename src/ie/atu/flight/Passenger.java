...
public class Passenger extends Person{//INHERITANCE-Passenger IS-A Person
	...
	private boolean priorityBoarding; // priorityBoarding & cardDetails
	...
	//    PaymentCard joesCard=new PaymentCard("1111222233334444L",
	//                                           new Date(31,12,2024),
	//                                           123);
	...
	public Passenger(Name name,String phoneNumber,String email,
			         int noBags,boolean pB,PaymentCard cardDetails){
	...
	public void setPaymentCard(PaymentCard cardDetails) {
		this.cardDetails = cardDetails;
	}
}
